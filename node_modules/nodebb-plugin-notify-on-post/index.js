...
(function () {
    ...
    function getNotificationFrom(notification) {
        if (!notification || !notification.bodyShort)
            return null;

        return notification.bodyShort.split(",")[1].trim();
    }
    ...
    var plugin = {
        ...
        notificationPushed: function (data, callback) {
            ...
            async.parallel([
                ...
                data.from = getNotificationFrom(data.notification);
