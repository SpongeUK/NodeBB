...
$(document).ready(function() {
	...
	$(window).on('action:ajaxify.end', function(ev, data) {
		...
		if (app.template === 'category' && app.user.uid) {
			console.log("TEMPLATE IS CATEGORY");
			...
			var cid = (ajaxify && ajaxify.data) ? ajaxify.data.cid : null; //ajaxify.variables.get('category_id');
			socket.emit('plugins.categoryNotifications.isSubscribed', {cid: cid}, function(err, isSubscribed) {
				console.log("RECIEVED IS SUBSCRIBER: ", isSubscribed);
				if (err) {
